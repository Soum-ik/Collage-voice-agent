...
// const Avatar: React.FC<{ status: AgentStatus; isWaving: boolean }> = ({
//   status,
//   isWaving,
// }) => {
...
//                         >
//                           <path d="M8.22 5.22a.75.75 0 0 1 1.06 0l2.5 2.5a.75.75 0 0 1 0 1.06l-2.5 2.5a.75.75 0 0 1-1.06-1.06L9.94 9.5H4.75a.75.75 0 0 1 0-1.5h5.19l-1.72-1.72a.75.75 0 0 1 0-1.06Z" />
//                           <path
//                             fillRule="evenodd"
//                             d="M14 8A6 6 0 1 1 2 8a6 6 0 0 1 12 0ZM4 8a4 4 0 1 1 8 0 4 4 0 0 1-8 0Z"
//                             clipRule="evenodd"
//                           />
//                         </svg>
//                         <span>
...
//     <div className="text-sm text-gray-300 space-y-3 whitespace-pre-wrap font-mono">
//       {KNOWLEDGE_BASE}
//     </div>
//   </div>
// );
...
//   }>({ input: null, output: null, processor: null, source: null });
//   const audioPlaybackRef = useRef<{
//     queue: Set<AudioBufferSourceNode>;
//     nextStartTime: number;
//   }>({ queue: new Set(), nextStartTime: 0 });
...
//             {error && (
//               <p className="text-red-400 mb-4 font-semibold text-base">
//                 {error}
//               </p>
//             )}
...
//                   className={`relative inline-flex items-center justify-center rounded-full w-48 h-48 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-white ${buttonColor} ${
//                     agentStatus === AgentStatus.Connecting || !password
//                       ? "cursor-not-allowed"
//                       : ""
//                   } ${
//                     !password && agentStatus !== AgentStatus.Connecting
//                       ? "opacity-50"
//                       : ""
//                   }`}
//                   title={
//                     !password ? "Please set and save a password first." : ""
//                   }
//                 >
//                   {pulse && (
